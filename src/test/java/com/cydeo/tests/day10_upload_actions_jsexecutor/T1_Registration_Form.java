...
public class T1_Registration_Form {
    ...
    public void registration_form_test(){
        ...
        Select jobTypeDropdown = new Select(Driver.getDriver().findElement(By.xpath("//*[@id=\"registrationForm\"]/div[10]/div/select")));
        jobTypeDropdown.selectByIndex(faker.number().numberBetween(1,8));

        //13.Select programming language from checkboxes

        WebElement progLangRadio = Driver.getDriver().findElement(By.xpath("//*[@id=\"inlineCheckbox2\"]"));
        progLangRadio.click();
        ...
        //displayed.
        WebElement resultText = Driver.getDriver().findElement(By.xpath("//p"));


        Assert.assertTrue(resultText.isDisplayed(), "You’ve successfully completed registration.");
